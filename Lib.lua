...
--[[ synz has upval instability
    ...
    table.insert(connectionList, runService.Heartbeat:Connect(function()
        ...
        replicationInterface.operateOnAllEntries(function(player, entry)
            ...
            -- Ghosts: ghost i sits at predStep*i seconds ahead.
            -- maxGhosts=1 → one ghost at the full totalPred window (furthest).
            -- maxGhosts=N → N ghosts evenly spaced up to totalPred.
